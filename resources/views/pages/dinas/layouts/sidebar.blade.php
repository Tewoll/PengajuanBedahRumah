<aside id="side-overlay">
    ...
    <div class="content-header">
        <!-- User Avatar -->
        <a class="img-link me-2" href="{{ route('profile.edit') }}">
            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    <li class="nav-main-item">
                        <a class="nav-main-link {{ request()->routeIs('dashboard-dinas.index') ? 'active' : '' }}" href="{{ route('dashboard-dinas.index') }}">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link {{ request()->routeIs('skoring.index') ? 'active' : '' }}" href="{{ route('skoring.index') }}">
                            <i class="nav-main-link-icon fa fa-file-signature"></i>
                            <span class="nav-main-link-name">Skoring</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
