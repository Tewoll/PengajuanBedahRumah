        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content">
                    @if ($isPersonalDataNull->dataDiri == null)
                        <form action="{{ route('data-diri.store') }}" id="simpan-form" method="POST"
                            enctype="multipart/form-data">
                        @else
                            <form id="simpan-form"
                                action="{{ route('data-diri.update', $isPersonalDataNull->dataDiri->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @method('PUT')
                    @endif
                    @csrf
                    <div class="row mb-2">
                        <div class="col-md-12 mb-2">
                            ...
                            <input id="nama" type="text" name="nama"
                                ...
                                {{ $isPersonalDataNull->dataDiri != null ? 'disabled' : '' }}>
                            @error('nama')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" {{ $isPersonalDataNull->dataDiri != null ? 'disabled' : '' }}
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12 mb-2">
                            <label for="nik_ktp" class="form-label">Nomor KTP <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text input-group-text-alt">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" {{ $isPersonalDataNull->dataDiri != null ? 'disabled' : '' }}
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <select name="pendidikan_terakhir" id="pendidikan_terakhir"
                                    ...
                                    {{ $isPersonalDataNull->dataDiri != null ? 'disabled' : '' }} placeholder=>
                    ...
                    <div class="row my-4">
                        <div class="col-md-12">
                            ...
                            @else
                                <a id="show-confirm-buttonx" class="btn btn-sm btn-primary btn-outline w-100"><i
                                        class="fa-solid fa-floppy-disk me-2"></i>Ubah Data</a>
                            @endif
                        </div>
                    </div>
                    </form>
...
@push('custom-script')
    ...
    @else
        <script>
            document.getElementById('show-confirm-buttonx').addEventListener('click', function() {
                Swal.fire({
                    title: 'Konfirmasi',
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = "{{ route('data-diri.edit', Auth::user()->id) }}";
                    }
                });
            });
        </script>
