        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                ...
                <div class="block-content">
                    <div class="container-fluid py-2 px-3">
                        ...
                        <form action="{{ route('data-pengajuan.surat-pengantar.store') }}" method="POST"
                            ...
                            <div class="row my-3">
                                @csrf
                                <div class="col-md-4">
                                    <label for="SuratPengantarKelurahan" class="form-label">Proposal Pengajuan dari Desa
                                        <span class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <input type="file" name="SuratPengantarKelurahan"
                                                id="SuratPengantarKelurahan" accept="application/pdf"
                    ...
                    <form action="{{ route('data-pengajuan.update', $dataPengajuan->id) }}" method="POST" enctype="multipart/form-data">
                        <div class="row my-5">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
