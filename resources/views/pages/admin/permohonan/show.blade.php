...
@section('content')
        ...
        <div class="content">
            <nav class="breadcrumb push bg-transparent rounded push px-4 py-2">
                <a class="breadcrumb-item" href="{{ route('permohonan.index') }}"><i class="fas fa-home me-1"></i>Data
                    Permohonan</a>
                <span class="breadcrumb-item active">Detail Data Permohonan</span>
            </nav>
            <div class="block block-rounded">
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light fs-sm">
                    <div class="row items-push py-4">
                        <div class="col-12 col-xl-4 text-xl-start">
                            <button id="show-confirm-tolak" type="button" class="btn btn-outline-danger"
                                data-toggle="click-ripple">Tolak</button>
                        </div>
                        <div class="col-12 col-xl-4 text-xl-center">
                            <button id="show-confirm-perbaikan" type="button" class="btn btn-outline-secondary"
                                data-toggle="click-ripple">Perbaikan
                                Data</button>
                        </div>
                        <div class="col-12 col-xl-4 text-xl-end">
                            <button id="show-confirm-setuju" type="button" class="btn btn-outline-success"
                                data-toggle="click-ripple">Setuju</button>
                        </div>
                    </div>
                </div>
            </div>
...
@push('custom-script')
    ...
    <script>
        document.getElementById('show-confirm-tolak').addEventListener('click', function() {
            Swal.fire({
                title: 'Konfirmasi',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ route('permohonan.konfirmasi', $dataPengajuan->id) }}',
                        data: {
                            _token: '{{ csrf_token() }}',
                            alasan: alasan,
                            konfirmasi: 'tolak', // Perhatikan bahwa ini harus string
                        },
                        success: function(response) {
                            Swal.fire({
                                ...
                                // Redirect ke halaman data-permohonan setelah alert berhasil ditutup
        ...
        document.getElementById('show-confirm-perbaikan').addEventListener('click', function() {
            Swal.fire({
                title: 'Konfirmasi',
                text: 'Apakah Anda yakin ingin melanjutkan?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            _token: '{{ csrf_token() }}',
                            alasan: alasan,
                            konfirmasi: 'perbaikan', // Perhatikan bahwa ini harus string
                        },
                        success: function(response) {
                            Swal.fire({
                                title: 'Sukses',
        ...
        document.getElementById('show-confirm-setuju').addEventListener('click', function() {
            Swal.fire({
                title: 'Konfirmasi',
                text: 'Apakah Anda yakin ingin melanjutkan?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            _token: '{{ csrf_token() }}',
                            konfirmasi: 'setuju', // Perhatikan bahwa ini harus string
                        },
                        success: function(response) {
                            Swal.fire({
                                title: 'Sukses',
