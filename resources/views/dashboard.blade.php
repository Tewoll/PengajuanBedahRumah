...
@section('content')
                ...
                <div class="row g-5 py-2">
                    <div class="col-md-4 py-2">
                        <a class="options-container push text-white rounded overflow-hidden" href="be_pages_dashboard.html"
                            target="_blank">
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-default.png"
                    ...
                    <div class="col-md-4 py-2">
                        <a class="options-container push text-white rounded overflow-hidden" href="db_classic.html"
                            target="_blank">
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-classic.png"
                        ...
                        <p class="fw-medium text-muted">
                            A classic and well tested approach for a project which is going to handle much data and needs
                    ...
                    <div class="col-md-4 py-2">
                        <a class="options-container push text-white rounded overflow-hidden" href="db_clean.html"
                            target="_blank">
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-clean.png"
                                alt="Dashboard Clean">
                            <div class="options-overlay bg-black-50">
                                <div class="options-overlay-content h5 fw-bold text-uppercase">
                                    <i class="fa fa-link fa-2x"></i>
                    ...
                    <div class="col-md-4 py-2">
                        <a class="options-container push text-white rounded overflow-hidden" href="db_social.html"
                            target="_blank">
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-social.png"
                        ...
                        <p class="fw-medium text-muted">
                            Building a social dashboard shouldn’t be hard. It should be easy, so you could spend more time
                            building your app.
                        </p>
                    </div>
                    <div class="col-md-4 py-2">
                        <a class="options-container push text-white rounded overflow-hidden" href="db_corporate.html"
                            target="_blank">
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-corporate.png"
                        ...
                        <p class="fw-medium text-muted">
                            Corporate dashboard design that is modern, clean and provokes the credibility you want for your
                            business.
                        </p>
                    </div>
                    <div class="col-md-4 py-2">
                        <a class="options-container push text-white rounded overflow-hidden" href="db_minimal.html"
                            target="_blank">
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-minimal.png"
                    ...
                    <div class="col-md-4 py-2">
                        <a class="options-container push text-white rounded overflow-hidden" href="db_pop.html"
                            target="_blank">
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-pop.png"
                                alt="Dashboard Pop">
                            <div class="options-overlay bg-black-50">
                                <div class="options-overlay-content h5 fw-bold text-uppercase">
                                    <i class="fa fa-link fa-2x"></i>
                        ...
                        <p class="fw-medium text-muted">
                            Material inspired design which give depth to your block elements and changes the way interact
                            with your dashboard.
                        </p>
                    </div>
                    <div class="col-md-4 py-2">
                        <a class="options-container push text-white rounded overflow-hidden" href="db_medical.html"
                            target="_blank">
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-medical.png"
                    ...
                    <div class="col-md-4 py-2">
                        <a class="options-container push text-white rounded overflow-hidden"
                            ...
                            <img class="img-fluid options-item" src="assets/media/various/preview-db-dashboard2.png"
                                alt="Dashboard Media">
                            <div class="options-overlay bg-black-50">
                                <div class="options-overlay-content h5 fw-bold text-uppercase">
                                    <i class="fa fa-link fa-2x"></i>
                        ...
                        <p>
                            More variations and examples are included in the main layout as well. Building the dashboard UI
                    ...
                    <div class="row g-5 py-2">
                        <div class="col-md-4 py-2">
                            <a class="options-container push text-white rounded overflow-hidden"
                                ...
                                <img class="img-fluid options-item"
                                    src="assets/media/various/preview-page-pack-crypto.png" alt="Page Pack Crypto">
                                <div class="options-overlay bg-black-50">
                                    <div class="options-overlay-content h5 fw-bold text-uppercase">
                                        <i class="fa fa-link fa-2x"></i>
                                    </div>
                        ...
                        <div class="col-md-4 py-2">
                            <a class="options-container push text-white rounded overflow-hidden"
                                ...
                                <img class="img-fluid options-item"
                                    src="assets/media/various/preview-page-pack-ecommerce.png" alt="Page Pack e-Commerce">
                                <div class="options-overlay bg-black-50">
                                    <div class="options-overlay-content h5 fw-bold text-uppercase">
                                        <i class="fa fa-link fa-2x"></i>
                                    </div>
                        ...
                        <div class="col-md-4 py-2">
                            <a class="options-container push text-white rounded overflow-hidden"
                                ...
                                <img class="img-fluid options-item"
                                    src="assets/media/various/preview-page-pack-elearning.png" alt="Page Pack e-Learning">
                                <div class="options-overlay bg-black-50">
                                    <div class="options-overlay-content h5 fw-bold text-uppercase">
                                        <i class="fa fa-link fa-2x"></i>
                                    </div>
                        ...
                        <div class="col-md-4 py-2">
                            <a class="options-container push text-white rounded overflow-hidden"
                                ...
                                <img class="img-fluid options-item" src="assets/media/various/preview-page-pack-forum.png"
                                    alt="Page Pack Forum">
                                <div class="options-overlay bg-black-50">
                                    <div class="options-overlay-content h5 fw-bold text-uppercase">
                                        <i class="fa fa-link fa-2x"></i>
                        ...
                        <div class="col-md-4 py-2">
                            <a class="options-container push text-white rounded overflow-hidden"
                                ...
                                <img class="img-fluid options-item" src="assets/media/various/preview-page-pack-auth.png"
                        ...
                        <div class="col-md-4 py-3">
                            <a class="options-container push text-white rounded overflow-hidden"
                                ...
                                <img class="img-fluid options-item" src="assets/media/various/preview-page-pack-error.png"
                                    alt="Page Pack Error">
                                <div class="options-overlay bg-black-50">
                                    <div class="options-overlay-content h5 fw-bold text-uppercase">
                                        <i class="fa fa-link fa-2x"></i>
            ...
            <div class="pt-7 pb-5">
                ...
                <div class="row g-6 py-2">
                    <div class="col-md-4 py-3">
                        ...
                        <p class="fw-medium text-muted mb-0">
                            Codebase’s layout is really unique, adaptive and flexible. It enables you to create all kinds of
                            pages that look great and work seamlessly across mobile and desktop devices.
                        </p>
                    </div>
                    <div class="col-md-4 py-3">
                        <h4 class="fw-bold mb-2">
            ...
            <div class="row g-0 pull-b text-center overflow-hidden">
                <div class="col-4">
                    <a class="options-container" href="be_pages_dashboard.html" target="_blank">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-layout-backend.png"
                            alt="Backend Promo">
                ...
                <div class="col-4">
                    <a class="options-container" href="db_classic.html" target="_blank">
                        <img class="img-fluid options-item"
                            src="assets/media/various/landing-promo-layout-classic-dashboard.png"
                ...
                <div class="col-4">
                    <a class="options-container" href="be_layout_api.html" target="_blank">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-layout-api.png"
            ...
            <div class="pt-7 pb-5">
                ...
                <div class="row g-6 py-2">
                    ...
                    <div class="col-md-4 py-3">
                        ...
                        <p class="fw-medium text-muted mb-0">
                            Bootstrap 5 and Codebase are designed to be used without jQuery. It is only used for providing
                            examples of popular plugins which are based on it.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row g-0 pull-b text-center overflow-hidden">
                <div class="col-4">
                    <a class="options-container" href="be_ui_grid.html" target="_blank">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-bootstrap-grid.png"
                ...
                <div class="col-4">
                    <a class="options-container" href="be_ui_typography.html" target="_blank">
                        <img class="img-fluid options-item"
                            src="assets/media/various/landing-promo-bootstrap-typography.png"
                ...
                <div class="col-4">
                    <a class="options-container" href="be_ui_buttons.html" target="_blank">
                        <img class="img-fluid options-item" src="assets/media/various/landing-promo-bootstrap-buttons.png"
    ...
    <div class="bg-body-extra-light">
        <div class="content content-full">
            <div class="pt-7 pb-5">
                ...
                <div class="row g-6 py-2">
                    <div class="col-md-4 py-3">
                        ...
                        <p class="fw-medium text-muted mb-0">
                            Codebase CSS framework was built with Sass following a completely modular approach. It is easy
                            to understand, customize and extend to fulfill your needs or project’s requirements.
                        </p>
                    </div>
                    <div class="col-md-4 py-3">
                        <h4 class="fw-bold mb-2">
                        ...
                        <p class="fw-medium text-muted mb-0">
                            Smart tasks will serve your project, auto refresh on file changes, live compile your ES6 to ES5
                            and Sass to CSS while you work (also auto adding any required browser prefixes).
                        </p>
                    </div>
                    <div class="col-md-4 py-3">
                        <h4 class="fw-bold mb-2">
                        ...
                        <p class="fw-medium text-muted mb-0">
                            Time-saving task that will build a custom, minimized and production ready Codebase framework for
                            you. Create your own variation based on your project.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row g-0 justify-content-center pull-b text-center overflow-hidden">
                <div class="col-sm-6">
                    <img class="img-fluid" src="assets/media/various/landing-promo-smart-tools.png"
    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="pt-7 pb-5">
                ...
                <div class="row g-6  py-2">
                    <div class="col-md-4 py-3">
                        ...
                        <p class="fw-medium text-muted mb-0">
                            We get to know you better by continuously listening to your feedback. This way, we learn where
                            to focus our efforts and build/improve quality products to better match your needs.
                        </p>
                    </div>
                    <div class="col-md-4 py-3">
                        <h4 class="fw-bold mb-2">
                    ...
                    <div class="col-md-4 py-3">
                        ...
                        <p class="fw-medium text-muted mb-0">
                            Working with someone else’s code can become uncomfortable and make you unproductive. We strive
                            to ensure that your experience with Codebase will be the exact opposite.
                        </p>
                    </div>
                </div>
            </div>
            <div class="row g-0 pull-b text-center overflow-hidden">
                <div class="col-4">
                    <img class="img-fluid" src="assets/media/various/landing-promo-developer-minded-php.png"
                        alt="Developer Minded PHP Promo">
                </div>
                <div class="col-4">
                    <img class="img-fluid" src="assets/media/various/landing-promo-developer-minded-docs.png"
                        alt="Developer Minded Docs Promo">
                </div>
                <div class="col-4">
                    <img class="img-fluid" src="assets/media/various/landing-promo-developer-minded-html.png"
            ...
            <div class="pt-7 pb-5">
                ...
                <div class="row g-6 py-2">
                    <div class="col-md-4 py-3">
                        ...
                        <p class="fw-medium text-muted mb-0">
                            We are passionate with what we do and love crafting products that can make your life easier and
                            help you succeed. We pay attention to small details and always aiming for the best.
                        </p>
                    </div>
                    <div class="col-md-4 py-3">
                        <h4 class="fw-bold mb-2">
                    ...
                    <div class="col-md-4 py-3">
                        ...
                        <p class="fw-medium text-muted mb-0">
                            We believe that design should be invisible and enhance the user experience, not get in the way.
                            This gives room for your content to breath and attracts your users’ attention to the right
                            place.
                        </p>
                    </div>
                </div>
                ...
                <div class="pt-7 pb-5">
                    ...
                    <div class="row g-4 py-2">
                        ...
                        <div class="col-md-4 py-3">
                            ...
                            <p class="fs-sm fw-medium text-muted mb-0">
                                Boilerplate RTL pages are also included in 'Get Started' section providing a great starting
                                point.
                            </p>
                        </div>
                        <div class="col-md-4 py-3">
